...
function factorize ( A, L, P ) {
  ...
  // If P is ommitted, shift all the arguments by one so that the 
  ...
  for(k=0; k<m; k++) {
    ...
    if( k > 0 ) {
      //console.log('Lk=',show(L.pick(k,null).hi(k)))
      //console.log('Li=',show(L.pick(i,null).hi(k)))
...
//module.exports.noSwapFactorize = lupWithoutSwap
